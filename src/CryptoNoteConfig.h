...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(10537818);
...
const uint64_t DIFFICULTY_TARGET                             = 19; // seconds
...
const char     CRYPTONOTE_NAME[]                             = "DIGICZK";
...
const int      P2P_DEFAULT_PORT                              = 78354;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 78354;
